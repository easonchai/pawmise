...
const contractAddress = "0x3ba99780cae8374577a0ad2e128bdb5b6cda3574439fee8288295e0719127084";
const lendingMarketId = "0xcd279e79afb09db41e18906d64a11b29f9dbcb8f1c5788a7eed9324499f86116";
...
const mintTokenMethod = async (
  ...
  const faucetId = "0xa017442bd11a0298c4bd918a4dd42a6b95e321538d8a8f6cc460ddfa06c532ef";
...
const depositTokensMethod = async (
  ...
  if (totalBalance < actualAmount) {
    throw new Error(`Insufficient MOCK balance: have ${totalBalance/1e9}, need ${amount}`);
  }
  ...
  tx.moveCall({
    ...
    typeArguments: [`${contractAddress}::pawmise::PAWMISE`, `${contractAddress}::mock_token::MOCK_TOKEN`], 
    arguments: [
